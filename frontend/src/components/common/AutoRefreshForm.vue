...
import { Props } from 'vue-chartjs/dist/props'
...
<template>
  <n-form :show-feedback="false" label-align="right" label-placement="left" label-width="auto" size="small">
    ...
    <n-form-item :label="$t('interface.refresh_interval')" :value="props.on" @update:value="onToggle">
      <n-input-number
        :autofocus="false"
        ...
        @update:value="(val: number) => emit('update:interval', val)">
        <template #suffix>
