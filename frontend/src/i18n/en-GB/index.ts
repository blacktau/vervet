export default {
  ...
  settings: {
    ...
    logging: {
      ...
      consoleHelp: 'Writes logs to stdout. Default on in dev builds, off in releases.',
      file: 'Log to file',
      fileHelp: 'Writes logs to a rotated file in the OS log directory.',
      maxSizeMB: 'Max size per file (MB)',
      maxBackups: 'Max backup files',
      revealFolder: 'Reveal logs folder',
      revealDisabledTitle: 'Open logs folder?',
      revealDisabledBody: 'Logging to file is currently disabled. The folder may still contain older logs. Open it anyway?',
      restartHint: 'Destination and rotation changes take effect on next restart. Log level changes apply immediately.',
    },
    updates: {
      title: 'Updates',
  ...
  schemaBrowser: {
    ...
    cancel: 'Cancel',
    retry: 'Retry',
    sampledOf: 'Sampled {sampled} of {total}',
    empty: 'Collection has no documents.',
    copyPath: 'Copy field path',
    createIndex: 'Create index on this field',
    copiedPath: 'Field path copied',
    inspectSchema: 'Inspect schema',
    columns: {
      field: 'Field',
      types: 'Types',
    ...
    legend: {
      label: 'Types',
      caption: 'Type lozenges show the BSON types observed for each field. The Presence column shows the percentage of sampled documents that contain the field.',
    },
    types: {
      string: 'String',
      int: 'Int',
    ...
    dialogs: {
      ...
      server: {
        ...
        auth: {
          ...
          none: {
            message: 'This mechanism does not require credentials.',
          },
          scram: {
            username: 'Username',
            password: 'Password',
            ...
            mechanism: 'Mechanism',
            mechanismAuto: 'Auto (server-selected)',
          },
          x509: {
            certFile: 'Certificate + key PEM file',
            certFilePlaceholder: '/path/to/client.pem',
            certFileBrowse: 'Browse…',
            certPassphrase: 'Key passphrase',
            usernameOverride: 'Username override',
            usernameOverrideHelp:
              'Optional — leave blank to derive from the certificate subject.',
            authSource: 'Auth source',
            authSourcePlaceholder: '$external',
          },
          aws: {
            accessKeyId: 'Access key ID',
            secretAccessKey: 'Secret access key',
            sessionToken: 'Session token',
            sessionTokenHelp: 'Optional — for temporary credentials (STS).',
          },
          gssapi: {
            principal: 'Principal',
            ...
            canonicalizeNone: 'None',
            canonicalizeForward: 'Forward',
            canonicalizeForwardReverse: 'Forward and reverse',
            serviceRealm: 'Service realm',
            password: 'Password',
            passwordHelp:
              'Usually unnecessary — Kerberos ticket cache is used by default.',
          },
          plain: {
            username: 'Username',
            password: 'Password',
          ...
          warnings: {
            missingUsername: 'Username is required for this mechanism.',
            missingCertFile: 'Certificate file path is required for X.509.',
            missingAwsKey: 'Access key ID is required for AWS.',
            missingAwsSecret: 'Secret access key is required for AWS.',
            missingPrincipal: 'Principal is required for Kerberos.',
          },
        },
      },
      export: {
