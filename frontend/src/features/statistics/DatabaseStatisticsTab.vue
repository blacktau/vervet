...
const cards = computed<StatCard[]>(() => {
  ...
  if (s.collections != null) {
    result.push({
      label: t('statistics.databaseCards.collections'),
      value: Number(s.collections).toLocaleString(),
    })
  }
  if (s.objects != null) {
    result.push({
      label: t('statistics.databaseCards.objects'),
      value: Number(s.objects).toLocaleString(),
    })
  }
  if (s.avgObjSize != null) {
    result.push({
      label: t('statistics.databaseCards.avgObjSize'),
  ...
  if (s.dataSize != null) {
    result.push({
      label: t('statistics.databaseCards.dataSize'),
      value: formatBytes(Number(s.dataSize)),
      subValue: t('statistics.bytes', { value: Number(s.dataSize).toLocaleString() }),
    })
  }
  if (s.storageSize != null) {
    result.push({
      label: t('statistics.databaseCards.storageSize'),
  ...
  if (s.indexSize != null) {
    result.push({
      label: t('statistics.databaseCards.indexSize'),
      value: formatBytes(Number(s.indexSize)),
      subValue: t('statistics.bytes', { value: Number(s.indexSize).toLocaleString() }),
    })
  }
